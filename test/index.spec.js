...
import HERETracking from '../lib/HERETracking.js';
...
describe('Given an instance of my library', function () {
  ...
  describe('when I set a correlationId', () => {
    it('should reject invalid correlationIds', () => {
      try {
        lib.correlationId = '123';
        throw new Error('Should not be here');
      } catch (e) {
        expect(e instanceof TypeError).to.be.true;
      }
    });
    it('should accept valid correlationIds', () => {
      try {
        lib.correlationId = 'E4881406-47CE-49E4-AB27-EF5D863B1E73';
        expect(lib._correlationId).to.equal('E4881406-47CE-49E4-AB27-EF5D863B1E73');
      } catch (e) {
        throw new Error('Should not be here');
      }
    });
